...
class H1RoughCfg( LeggedRobotCfg ):
    ...
    class asset( LeggedRobotCfg.asset ):
        ...
        # file = '{LEGGED_GYM_ROOT_DIR}/resources/robots/h1/urdf/h1_new.urdf'
        file = '{LEGGED_GYM_ROOT_DIR}/resources/robots/h1/urdf/h1_hand_upper.urdf'
        name = "h1"
        foot_name = "ankle"
    ...
    class rewards( LeggedRobotCfg.rewards ):
        ...
        # # previous version without upper body
